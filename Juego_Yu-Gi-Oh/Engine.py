    ...
    def usarTecnica(self, jugador, enemigo):
        ...
        if tec=="1":
            if (jugador.getTecnica1(0).getDanoFisico()) > 0:
                ...
                print("La tecnica es usado y es el siguiente : " + str(jugador.getTecnica1(0).getNombre())  + " la vida de " + enemigo.getNombre() +  " es: " + str(enemigo.getVida()))

        elif tec=="2":
            if (jugador.getTecnica1(1).getDanoFisico()) > 0:
                enemigo.recibirDanoFisico(int(jugador.getTecnica1(1).getDanoFisico()))
                print("La tecnica es usado y es el siguiente : " + str(jugador.getTecnica1(1).getNombre())  + " la vida de " + enemigo.getNombre() +  " es: " + str(enemigo.getVida()))
